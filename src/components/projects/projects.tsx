...
export const Projects: ProjectProps[] = [
  {
    ...
    purpose: "E-commerce platform for seamless online shopping",
    technologies:
      "React, JavaScript, React Router, React Slick Slider, Axios, React Bootstrap, React Hook Form",
    key_feature:
...

  {
    ...
    paragraph:
      "I developed a responsive website for Intopros Technology, showcasing their IT services with a modern design, interactive elements, and optimized performance, reflecting their brand and expertise.",
    purpose: "Company Profile",
    technologies:
      "React, JavaScript, React Router, React Slick Slider, Axios, React Bootstrap",
    key_feature:
      "Dynamic slider, form validation, responsive design, carousel integration",
    challenges:
      "Created a React Slick slider and ensured mobile responsiveness",
  ...
  },
  {
    ...
    purpose: "E-commerce platform for seamless online shopping",
    technologies:
      "React, JavaScript, React Router, React Slick Slider, Axios, React query, Tailwind css, React Hook Form",
    key_feature:
      "Dynamic slider, form validation, responsive design, carousel integration",
    challenges:
      "Created a React Slick slider and ensured mobile responsiveness",
  ...
  },
  {
    ...
    technologies:
      "React, JavaScript, React Router, React Slick Slider, Axios, MUI materials",
    key_feature: "Dynamic slider,responsive design, carousel integration",
    challenges:
      "Created a React Slick slider and ensured mobile responsiveness",
    link: "/",
  ...
  },
  {
    ...
    purpose:
      "To provide a simple platform for tracking and managing financial transactions like expenses, payments, and loans.",
    technologies:
      "React, Typescript, Vite,  React Router, React Slick Slider, Axios, React query, Tailwind css, React Hook Form",
    key_feature:
      "Dynamic slider, form validation, responsive design, carousel integration",
    challenges:
      "Created a React Slick Slider and ensured mobile responsiveness",
  ...
  },
  {
    ...
    purpose:
      "To create a fully functional Netflix clone website using the TMDB API for movie data",
    technologies: "HTML, JavaScript, CSS Axios",
  ...
  },
  {
    ...
    purpose: "E-learning",
    technologies:
      "React, JavaScript, React Router, Axios, MUI materials, React Hook Form",
    key_feature:
      "Dynamic slider, form validation, responsive design, carousel integration",
    challenges: "ensured mobile responsiveness",
    link: "/",
  ...
  },
  {
    ...
    purpose: "",
    technologies:
      "React, Typescript, vite, React Router, React Slick Slider, Axios, Tailwind css",
    key_feature:
      "Dynamic slider, responsive design, carousel integration",
    challenges:
      "Created a  React Slick Slider and ensured mobile responsiveness",
